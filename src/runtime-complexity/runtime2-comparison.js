...
// As the set.has() or set.add() is O(1), it would not add up.
...
// O(nlogn) becuase of the sort algorithm
...
// O(n^2) for the function
// There are two nested O(n) from the for loop and the array.indexOf() methodsmoment().add(10, 'days').calendar()
// These adds up to O(n^2)
