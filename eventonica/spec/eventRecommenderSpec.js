describe("EventRecommender", () => {
  const { EventRecommender, User, Event } = require('./Users/nasreen/techtonica/assignments/eventonica/src/eventRecommender.js'); // Update with your class names and file name
  let er; 
